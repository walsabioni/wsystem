                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        foreach ($results as $r) {
                            ...
                            if ($r->faturado == '1') {
                                $valorFaturado = floatval($r->valor_desconto) > 0
                                    ? $r->valor_desconto
                                    : $r->valorTotal;
                            } else {
                                $valorFaturado = 0;
                            ...
                            echo '<td>R$ ' . number_format(floatval($r->valor_desconto) > 0 ? $r->valor_desconto : $r->valorTotal, 2, ',', '.') . '</td>';
                            echo '<td class="ph4">R$ ' . number_format($valorFaturado, 2, ',', '.') . '</td>';
