                        ...
                        <table width="100%" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($vendas as $v) {
                                    ...
                                    echo '<td align="center">R$: ' . number_format($v->valor_desconto != 0 ? $v->valor_desconto : $v->total_produto, 2, ',', '.') . '</td>';
                                    echo '</tr>';
                                }
                                ?>
                                <tr>
                                        ...
                                        <b>R$:
                                            <?php
                                                ...
                                                foreach ($vendas as $value) {
                                                    $sum += $value->valor_desconto != 0 ? $value->valor_desconto : $value->total_produto;
                                                }
